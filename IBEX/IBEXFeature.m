...
%Set text on UI
TextStr='<html><b><center><font size="4" face="Times New Roman" color="rgb(0,0,0)">Add to<br />Feature Set</font></html>';
...
%UITablePreprocess
TableHeader=[];
TableHeader=[TableHeader, {['<html><b><center><font size="4" face="Times New Roman" color="rgb(0,0,100)">', 'Order']}];
TableHeader=[TableHeader, {['<html><b><center><font size="4" face="Times New Roman" color="rgb(0,0,100)">', 'Name']}];
TableHeader=[TableHeader, {['<html><b><center><font size="4" face="Times New Roman" color="rgb(0,0,100)">', 'Para.']}];
TableHeader=[TableHeader, {['<html><b><center><font size="4" face="Times New Roman" color="rgb(0,0,100)">', ' ']}];
