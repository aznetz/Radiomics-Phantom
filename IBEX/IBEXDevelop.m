...
[TempIcon, map]=imread('DevelopImport.jpg');        
set(handles.PushbuttonImportPlugIn, 'CData', TempIcon, 'String', ' ');

[TempIcon, map]=imread('DevelopPreprocess.jpg');        
set(handles.PushbuttonPreprocessPlugIn, 'CData', TempIcon, 'String', ' ');

[TempIcon, map]=imread('DevelopFeature.jpg');        
set(handles.PushbuttonFeaturePlugIn, 'CData', TempIcon, 'String', ' ');


[TempIcon, map]=imread('DevelopStandalone.jpg');        
set(handles.PushbuttonStandAlonePlugIn, 'CData', TempIcon, 'String', ' ');
