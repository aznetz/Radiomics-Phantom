...
FileName='C:\Work\Papers\ClinicStudy\Choi\Band_Texture_M.xlsm';

SheetNamePre={'Cat1'; 'Cat2'; 'Cat3'};
BandNum=3:2:13;
...
for mm=1:length(BandNum)    
    
    SheetName={[SheetNamePre{1}, 'Band', num2str(BandNum(mm))]; ...
        [SheetNamePre{2}, 'Band', num2str(BandNum(mm))]; ...
        [SheetNamePre{3}, 'Band', num2str(BandNum(mm))]};
    
    TempStr=[OutRangeStartStr, num2str(OutRangeStartRow+(mm-1)*OffsetRow), ':', OutRangeEndStr, num2str(OutRangeStartEnd+(mm-1)*OffsetRow)];
    OutRangeStr={TempStr; TempStr};
