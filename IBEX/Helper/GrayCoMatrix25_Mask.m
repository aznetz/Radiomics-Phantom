function [GLCMS,SI] = GrayCoMatrix25_Mask(varargin)
...
[I, Mask, Offset, NL, GL, makeSymmetric] = ParseInputs(varargin{:});
...
for i=1:PageNum
    ...
    %Use NaN to remove
    %outsideBoundsMask=find(Mask(:, :, i)< 1);    
...
% Check I
I = varargin{1};
iptcheckinput(I,{'logical','numeric'},{'real','nonsparse'}, ...
              mfilename,'I',1);
