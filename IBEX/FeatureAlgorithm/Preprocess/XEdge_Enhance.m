function [ResultStruct, ResultStructBW]=XEdge_Enhance(CDataSetInfo, Param)
%%%Doc Starts%%%
%-Description: 
%This method is to apply 2D sobel horizontal edge-emphasizing filter in slice-by-slice. 
