function FeatureInfo=NeighborIntensityDifference3_Feature(ParentInfo, FeatureInfo, Mode)
...
function [Value, ReviewInfo]=NeighborIntensityDifference3_Feature_Coarseness(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=NeighborIntensityDifference3_Feature_Contrast(ParentInfo, Param)
%%%Doc Starts%%%
%For the feature description, refer to the paper below.
%  "Amadasun, M.; King, R. Textural features corresponding to textural properties.
%   IEEE Transactions on Systems, Man and Cybernetics,Volume 19 Issue 5, Page 1264-1274 "
...
function [Value, ReviewInfo]=NeighborIntensityDifference3_Feature_Busyness(ParentInfo, Param)
%%%Doc Starts%%%
%For the feature description, refer to the paper below.
%  "Amadasun, M.; King, R. Textural features corresponding to textural properties.
%   IEEE Transactions on Systems, Man and Cybernetics,Volume 19 Issue 5, Page 1264-1274 "
...
function [Value, ReviewInfo]=NeighborIntensityDifference3_Feature_Complexity(ParentInfo, Param)
%%%Doc Starts%%%
%For the feature description, refer to the paper below.
%  "Amadasun, M.; King, R. Textural features corresponding to textural properties.
%   IEEE Transactions on Systems, Man and Cybernetics,Volume 19 Issue 5, Page 1264-1274 "
...
function [Value, ReviewInfo]=NeighborIntensityDifference3_Feature_TextureStrength(ParentInfo, Param)
%%%Doc Starts%%%
%For the feature description, refer to the paper below.
%  "Amadasun, M.; King, R. Textural features corresponding to textural properties.
%   IEEE Transactions on Systems, Man and Cybernetics,Volume 19 Issue 5, Page 1264-1274 "
...
switch Mode
    case 'Coarseness'        
        Value=1/(Epsilon+sum(NIDStruct.HistOccurPropability.*NIDStruct.HistDiffSum));
    ...
    case 'Busyness'
        WeightDiff=NIDStruct.HistOccurPropability.*NIDStruct.HistDiffSum;
