function FeatureInfo=GrayLevelCooccurenceMatrix3_Feature(ParentInfo, FeatureInfo, Mode)
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Contrast(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Correlation(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
% For the feature description, refer to the documentation on MATLAB function "graycoprops".
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Energy(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
% For the feature description, refer to the documentation on MATLAB function "graycoprops".
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Homogeneity(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Entropy(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_AutoCorrelation(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. L. Soh and C. Tsatsoulis. Texture analysis of sar sea ice imagery using gray level co-occurances matrices.
%    IEEE Trans. on Geoscience and Remote Sensing, 37(2):780–795, 1999
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Dissimilarity(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. L. Soh and C. Tsatsoulis. Texture analysis of sar sea ice imagery using gray level co-occurances matrices.
%    IEEE Trans. on Geoscience and Remote Sensing, 37(2):780–795, 1999
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_ClusterShade(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. L. Soh and C. Tsatsoulis. Texture analysis of sar sea ice imagery using gray level co-occurances matrices.
%    IEEE Trans. on Geoscience and Remote Sensing, 37(2):780–795, 1999
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_ClusterProminence(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. L. Soh and C. Tsatsoulis. Texture analysis of sar sea ice imagery using gray level co-occurances matrices.
%    IEEE Trans. on Geoscience and Remote Sensing, 37(2):780–795, 1999
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_ClusterTendendcy(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. L. Soh and C. Tsatsoulis. Texture analysis of sar sea ice imagery using gray level co-occurances matrices.
%    IEEE Trans. on Geoscience and Remote Sensing, 37(2):780–795, 1999
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_MaxProbability(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. L. Soh and C. Tsatsoulis. Texture analysis of sar sea ice imagery using gray level co-occurances matrices.
%    IEEE Trans. on Geoscience and Remote Sensing, 37(2):780–795, 1999
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_DifferenceEntropy(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Homogeneity2(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_InformationMeasureCorr1(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_InformationMeasureCorr2(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_InverseDiffMomentNorm(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_InverseDiffNorm(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_InverseVariance(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_SumAverage(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_SumEntropy(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_SumVariance(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Haralick, R.M., K. Shanmugan, and I. Dinstein, "Textural Features for Image Classification", 
%    IEEE Transactions on Systems, Man, and Cybernetics, Vol. SMC-3, 1973, pp. 610-621.
...
function [Value, ReviewInfo]=GrayLevelCooccurenceMatrix3_Feature_Variance(ParentInfo, Param)
%%%Doc Starts%%%
%-Reference:
%1. Hugo J. W, Sara Cavalho, et al. Decoding tumour phenotype by noninvasive imaging using a quantitative radiomics approach.
%   Nat. Commun. 2014; 5: 4006.
