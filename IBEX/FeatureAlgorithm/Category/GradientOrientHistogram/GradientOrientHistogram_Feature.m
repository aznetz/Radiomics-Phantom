function FeatureInfo=GradientOrientHistogram_Feature(ParentInfo, FeatureInfo, Mode)
...
%Feature: TTTT
%Global features
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_Skewness(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_Kurtosis(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_Range(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_MeanAbsoluteDeviation(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_MedianAbsoluteDeviation(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_InterQuartileRange(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_Percentile(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_PercentileArea(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
function [Value, ReviewInfo]=GradientOrientHistogram_Feature_Quantile(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
